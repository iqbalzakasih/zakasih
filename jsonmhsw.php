...
$link = mysqli_connect('localhost', 'id12789063_zakasih', 'Panser1932', 'id12789063_akademik');
...
if (strcmp($data, 'data') ==0) {
 ...
 case 'GET':
    ...
    echo "select * from pengguna ";break;
    }
    else
    {
         $sql = "select * from pengguna where id='$id'";
         echo "select * from pengguna where id='$id'";break;
...
if ($method == 'POST') {
		...
		$querycek = "SELECT id,nama,email,negara FROM pkl WHERE id ='$id'";
